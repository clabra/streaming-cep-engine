...
public class SimpleMaxQueryBenchmark extends BaseSimpleInOutBenchmark {

    private static final String OUT_STREAM = "max_q_out_stream";
    private static final String IN_STREAM = "max_q_in_stream";

    public SimpleMaxQueryBenchmark(String kafkaHost, int kafkaPort, String zookeeperHost, int zookeeperPort) {
    ...
    protected void commandApiActions(IStratioStreamingAPI stratioStreamingAPI) throws StratioEngineStatusException,
        ...
        stratioStreamingAPI.addQuery(IN_STREAM, "from " + IN_STREAM
                + " select max(data) as max group by ind insert into " + OUT_STREAM);
    ...
    protected String getBenchmarkDescription() {
        return "Simple max siddhi query.";
    }
